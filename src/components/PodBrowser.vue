        ...
        <div>
            <b-button-toolbar key-nav aria-label="Toolbar with button groups">
                ...
                <b-input-group size="sm">
                    ...
                    <b-button :disabled="pod == null" size="sm" variant="primary" @click="saveBrainToSolid"
                        title="Save to Solid pod"><b-icon-cloud-upload></b-icon-cloud-upload></b-button>
                </b-input-group>
                <!--
        <b-button-group class="mx-1">
...
export default {
    ...
    components: {
        ...
        'LocalConnector': () => import('../views/connectors/LocalConnector.vue'),
    },
    data() {
        return {
            // currentPath: ""
